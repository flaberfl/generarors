...
const objPopupVideo = document.querySelectorAll('.popup-video');
...
objPopupVideoLink.forEach((element, i) =>
  element.setAttribute('data-popup', '#popup-video' + '-' + i));

for (var i = 0, b; b = document.getElementById('popup-video'); ++i) {
  b.id += '-' + i;
}
